export default {
  ...
  points: {
    ...
    withdraw: {
      title: '提现',
      desc: '提交提现申请，由人工审核并打款；USDT 提现需选择链路。',
      method: '收款方式',
      alipay: '支付宝',
      usdt: 'USDT',
  ...
  userSubscriptions: {
    ...
    lifecycle: {
      ...
      dFixed: '续费不改每日额度',
      price: '价格',
      renewPrice: '续费价（套餐价值 USD）',
      renewValue: '续费套餐价值（USD）',
      changeDiff: '补差价（套餐价值 USD）',
      changeDiffValue: '补差套餐价值（USD）',
      newPlanPrice: '新套餐价值',
      oldRemainingValue: '旧卡剩余价值',
