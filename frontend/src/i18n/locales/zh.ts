export default {
  ...
  points: {
    ...
    invite: {
      ...
      rewardFormula: '首笔按 {firstRate}，后续按 {repeatRate}；1 积分 = {peg}。',
    ...
    admin: {
      config: {
        ...
        valueSection: '2. 积分提现 / 转余额 / 抵扣比例',
        peg: '积分:法币比值',
        pegHint: '填写 1 积分折合多少法币金额；例如 0.01 表示 100 积分 = 1 法币。提现、转余额、订阅抵扣共用这个比例。',
        ...
        redeemBalanceHint: '开启后积分按上面的积分:法币比值转入用户余额。',
