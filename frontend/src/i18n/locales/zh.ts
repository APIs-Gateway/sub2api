  ...
  points: {
    ...
    admin: {
      config: {
        title: '积分配置',
        enabled: '启用积分功能',
        earnSection: '1. 法币充值返积分',
        earnHint: '邀请人获得积分 = 订单实付法币金额 × 返积分比例 ÷ 积分:法币比值，向下取整；被邀请新用户首笔法币支付按 2 倍积分计算。',
        cashbackRate: '法币充值返积分比例（%）',
        cashbackRateHint: '例如 10 表示按实付金额的 10% 折算积分。',
