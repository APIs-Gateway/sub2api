export default {
  ...
  nav: {
    ...
    redeem: '兑换',
    affiliate: '邀请积分',
    affiliateManagement: '邀请与积分',
    affiliateCashback: '邀请管理',
    affiliateInviteRecords: '邀请记录',
    affiliateRebateRecords: '邀请积分记录',
    affiliateTransferRecords: '提取记录',
    points: '邀请和积分',
    pointsManagement: '积分',
    pointsConfig: '积分配置',
    pointsWithdrawals: '提现审核',
    pointsRecords: '积分记录',
    profile: '个人资料',
    users: '用户管理',
    groups: '分组管理',
  ...
  legacyInvite: {
    ...
    successTitle: '邀请码已到手',
    successHint: '这个邀请码只能使用一次，请先复制保存，再前往注册。',
    alreadyClaimedHint: '你之前已经领过了，这是同一个邀请码。',
    expiresAt: '有效期至 {date}',
    copy: '复制',
    copied: '已复制',
    goRegister: '去注册',
  ...
  keys: {
    ...
    stablePriority: {
      ...
      billingWarning: '注意：兜底期间将按实际服务的高倍率分组费率从你的余额计费，费用可能高于原分组。',
    },
  ...
  usage: {
    ...
    upstreamModelMismatchHint: '上游返回的模型与实际请求的模型不一致，该请求已被拦截（或处于观察模式）',
  ...
  availableChannels: {
    ...
    buyPlans: '查看套餐',
    payHint: '实付 = 模型单价 ×',
    effectiveTitle: '本档位实付（× {rate}）',
    tiersTitle: '按量档位',
    tiersHint: '倍率越高的池子越稳定、同样用量扣得也越多；点模型名查看官方单价。',
    plansTitle: '月套餐',
    plansHint: '低价换大额官方价额度，叠加套餐后实际相当于官方价的很低折扣。',
    goBuy: '去购买',
    empty: '暂无可用线路',
    noModels: '未配置模型',
    noPricing: '未配置定价',
  ...
  checkin: {
    ...
    activityNotMet: '今日活跃度未达标',
    activityHint: '继续使用后可再来签到',
    claimDaily: '立即签到',
    claimBonus: '领取额外签到',
    claiming: '领取中…',
    doneToday: '今日已签到',
  ...
  points: {
    title: '邀请和积分',
    description: '被邀请人付款即可获得积分。积分可兑换余额、提现，或兑换套餐。',
    disabled: '积分功能当前不可用。',
    unit: '积分',
    loadFailed: '加载积分数据失败。',
    ...
    stats: {
      ...
      frozen: '冻结中',
      lifetime: '累计获得',
      effectiveRate: '邀请积分比例',
      peg: '面值',
      firstPaymentRate: '首次付款 {rate}',
      repeatPaymentRate: '后续付款 {rate}',
      pegValue: '1 积分 = {value}',
    },
    invite: {
      code: '邀请码',
      ...
      empty: '还没有被邀请人。',
      rewardTitle: '邀请奖励',
      rewardExample: '被邀请人实付 {amount}：首笔约 {firstPoints} 积分，之后每笔约 {repeatPoints} 积分。',
      rewardFormula: '每个被邀请用户的首笔付款按 {firstRate}，这个用户之后的付款按 {repeatRate}；1 积分 = {peg}。',
      rewardDisabled: '当前邀请积分比例为 0，被邀请人付款暂不会产生积分。',
    },
    redeemBalance: {
      title: '兑换余额',
      desc: '按积分法币面值和当前充值倍率折算为钱包余额。',
      points: '兑换积分数',
      estimate: '将获得 {amount} 余额。',
      rateHint: '1 积分 = {peg}，兑换余额按 1 CNY = {rate} USD 折算。',
      submit: '兑换',
      success: '已兑换为余额。',
    },
    withdraw: {
      title: '提现',
      desc: '提交提现申请，由人工审核并打款；支付宝按人民币打款，USDT 按提现汇率折算并需选择链路。',
      method: '收款方式',
      alipay: '支付宝',
      usdt: 'USDT',
      alipayAccount: '支付宝账号（手机号 / 邮箱）',
      alipayName: '支付宝真实姓名',
      usdtChain: 'USDT 链路',
      usdtChains: {
        trc20: 'TRC20',
    ...
    redeemPlan: {
      ...
      quoteLoading: '计算中',
      quoteFailed: '获取套餐报价失败',
      downgradeBlocked: '当前套餐每日额度更高，不能兑换低档套餐；请选择同档续费或更高每日额度的套餐。',
      capSummary: '周 / 月封顶',
      validity: '{n} 天',
      submit: '兑换',
      success: '套餐已开通。',
      empty: '暂无可兑换的套餐。',
      confirm: '确认{action} {plan}，扣除 {points} 积分？',
    },
    ledger: {
      title: '积分明细',
      time: '时间',
    ...
    admin: {
      config: {
        ...
        enabled: '启用积分功能',
        earnSection: '1. 邀请积分',
        earnHint: '邀请人获得积分 = 被邀请人实付法币金额 × 邀请积分比例 ÷ 积分:法币比值，向下取整；被邀请新用户首笔法币支付按 2 倍积分计算。',
        cashbackRate: '邀请积分比例（%）',
        cashbackRateHint: '例如 10 表示按被邀请人实付金额的 10% 折算积分。',
        freezeHours: '积分到账冻结期（小时）',
        freezeHoursHint: '冻结期结束后积分才可提现、转余额或抵扣套餐。',
        valueSection: '2. 积分法币面值',
        peg: '1 积分折合法币',
        pegHint: '填写 1 积分折合多少法币金额；例如 1 表示 1 积分 = ¥1，0.01 表示 100 积分 = ¥1。兑换余额会再按支付设置里的余额充值倍率折算为 USD 余额；提现、订阅抵扣共用这个法币面值。',
        pegConfirmTitle: '确认修改积分:法币比值',
        pegChangeConfirm: '确定把积分:法币比值从 {from} 改为 {to}？这会重估全部存量积分的价值，且此变更会被审计留痕。',
        withdrawSection: '3. 积分提现',
        withdrawSectionHint: '开启后用户可把积分按积分:法币比值申请提现。',
        withdrawMin: '最低提现积分',
        withdrawFee: '提现手续费（%）',
        withdrawFeeHint: '实付金额 = 积分 × 积分:法币比值 × (1 - 手续费)。',
        withdrawUSDCNYRate: 'USD/CNY 日价',
        withdrawUSDCNYRateHint: '仅用于 USDT 提现；创建提现单时会固化汇率快照。',
        redeemBalanceOn: '4. 允许积分转余额',
        redeemBalanceHint: '开启后积分先按法币面值折算，再按支付设置里的余额充值倍率转入用户 USD 余额。',
        redeemPlanOn: '5. 允许积分全额抵扣订阅',
        redeemPlanHint: '开启后积分可按上面的积分:法币比值全额抵扣订阅购买、续费和转套餐。',
        save: '保存',
        saved: '配置已保存。',
      },
      withdrawals: {
        ...
        reject: '驳回',
        note: '备注',
        notePlaceholder: '可选：填写驳回原因',
        proof: '打款凭证（可选）',
        approveConfirm: '将该提现标记为已打款？',
        rejectConfirm: '驳回并退回用户积分？',
        approved: '已标记打款。',
        rejected: '已驳回并退回。',
        empty: '暂无提现。',
        filterStatus: '状态',
  ...
  affiliate: {
    ...
    codeCopied: '邀请码已复制',
    linkCopied: '邀请链接已复制',
    loadFailed: '加载邀请积分数据失败',
    transferFailed: '转入余额失败',
    stats: {
      rebateRate: '我的邀请积分比例',
      rebateRateHint: '被邀请用户付款后你可获得的积分比例',
      invitedUsers: '邀请人数',
      availableQuota: '可转积分额度',
      frozenQuota: '冻结中',
      frozenQuotaHint: '新产生的积分正在冻结期中',
      totalQuota: '历史积分额度'
    },
    transfer: {
      title: '积分额度转余额',
      description: '将当前可用积分额度一键转入账户余额',
      button: '转入余额',
      transferring: '转入中...',
      empty: '当前没有可转入额度',
    ...
    tips: {
      ...
      line2: '被邀请用户付款后，你可获得 {rate} 的积分额度。',
      line3: '积分额度可按配置兑换余额、提现或兑换套餐。',
      line4: '新产生的积分需要经过冻结期后才能使用。'
    }
  },

  inviteCashback: {
    title: '邀请积分',
    description: '邀请好友注册，好友兑换或付款后按比例获得积分',
    loadFailed: '加载邀请积分数据失败',
    copied: '已复制',
    stats: {
      rate: '当前邀请积分比例',
  ...
  admin: {
    ...
    affiliates: {
      cashback: {
        description: '余额兑换码按兑换金额计算邀请积分；订阅兑换码按订阅条目单独配置积分基数',
        enabled: '启用邀请积分',
        rate: '邀请积分比例 (%)',
        faceValues: '订阅积分基数映射',
        balanceHint: '余额类型兑换码不需要单独配置基数，系统会直接按兑换金额乘邀请积分比例计算。',
        redeemType: '兑换码类型',
        subscriptionItem: '订阅条目',
      ...
      overview: {
        ...
        rebateRate: '邀请积分比例',
        invitedCount: '邀请人数',
        rebatedInviteeCount: '已产生积分人数',
        availableQuota: '可提旧余额',
        historyQuota: '历史积分'
      }
    },
    ...
    channels: {
      ...
      display: {
        entry: '对外展示设置',
        title: '价格页对外展示设置',
        intro: '配置用户「价格与计费」页展示哪些分组与模型。两者都留空表示全部展示。',
        modelsLabel: '展示哪些模型',
        searchModels: '搜索模型...',
        clear: '清空',
        noModels: '无匹配模型',
      ...
      form: {
        ...
        secMapping: '模型映射',
        secAdvanced: '高级',
        groupRateHint: '标签 Nx = 该分组相对官方价的倍率（用户实付 = 模型单价 × 倍率）',
        wildcardHint: '支持通配符 *，如 gpt-5* / claude-*；命中多个时更具体的优先',
        models: '模型列表',
        ...
        codexImageGenerationBridge: 'Codex Hosted 图片桥接',
        codexImageGenerationBridgeHint: '开启后，OpenAI 分组仅会为非 Responses Lite 的 Codex /responses 文本请求注入 hosted image_generation 工具。桥接不会为 Responses Lite 注入工具；客户端声明的本地 image_gen 由客户端和账号策略决定。仅在路由账号支持图片生成时开启。',
    ...
    promptAudit: {
      title: '提示词审计',
      description: '查看安全护栏管道捕获的脱敏提示词审计事件。',
      loadFailed: '加载提示词审计事件失败',
      loadEventFailed: '加载提示词审计事件详情失败',
      refresh: '刷新',
      filters: {
        decision: '判定结果',
        riskLevel: '风险等级',
        keyword: '关键字',
        keywordPlaceholder: '搜索请求 ID、提示词哈希、用户或 API 密钥',
      },
      decisions: {
        pass: '通过',
        flag: '标记',
      ...
      detail: {
        ...
        stage: '阶段',
        promptLength: '提示词长度',
        promptLengthChars: '{n} 字符',
        messageCount: '消息数',
        promptHash: '提示词哈希',
        redactedPreview: '脱敏预览',
        redactedPreviewHint: '此预览在采集时已脱敏处理，完整提示词内容不会在此存储或展示。',
        categories: '风险分类',
        matchedScanners: '命中扫描器',
        scannerScores: '扫描分数',
        scannerEvidence: '扫描依据',
        issues: '问题摘要',
        issuesEmpty: '该事件暂无问题记录。',
        issueSeverity: '严重程度',
        issueAction: '处理动作',
        issueScore: '分数',
        issueEvidence: '依据',
    ...
    channelMonitor: {
      ...
      advanced: {
        ...
        responseFormat: '响应解析',
        responseFormatJson: 'JSON（默认）',
        responseFormatSse: 'SSE 流式',
        responseFormatHintJson: '把上游响应当作单个 JSON 文档，按字段路径提取文本（默认行为）。',
        responseFormatHintSse: '把上游响应当作 SSE 事件流逐条聚合文本（与「测试账号连接」一致）。当上游用 stream:true 返回事件流、JSON 模式抽取为空（replace-mode: upstream returned 2xx with empty text）时改用此项。',
        bodyMode: '请求体处理',
        bodyModeOff: '默认',
        bodyModeMerge: '合并',
        bodyModeReplace: '覆盖',
    ...
    accounts: {
      ...
      upstreamBilling: {
        trustWarning: '该倍率由当前 API Key 连接的上游站点声明，Sub2API 无法验证它是否等于实际扣费。上游站点或中间服务可能返回伪造、过期或被修改的数据，请结合账单、余额变化和实际用量核对。',
        autoProbe: '自动探测上游声明倍率',
        autoProbeHint: '开启全局探测后，按全局周期探测此账号的上游声明倍率。',
        manualProbe: '立即探测上游倍率',
        stale: '已过期',
        unsupported: '不支持',
        failed: '失败',
        notProbed: '未探测',
        groupRate: '分组默认倍率：{value}x',
        userRate: '用户倍率：{value}x',
      ...
      types: {
        ...
        antigravityProjectIdHint:
          'standard-tier 且未自动返回 project_id 的 Antigravity 账号需要填写用户自有的 GCP project。',
        upstream: '对接上游',
      ...
      openai: {
        ...
        codexImageGenerationBridge: 'Codex Hosted 图片生成桥接',
        codexImageGenerationBridgeDesc:
          '控制 Codex /responses 文本请求中的 hosted image_generation 桥接和客户端图片工具声明。Hosted 工具仅在非 Responses Lite 请求中注入；image-only 模型路由和独立图片生成接口不受影响。',
        codexImageGenerationBridgeInherit: '跟随渠道',
        codexImageGenerationBridgeInheritDesc: '不写入账号覆盖；非 Responses Lite 请求是否注入 hosted 工具由渠道或全局策略决定，客户端显式携带的 hosted 工具和本地 image_gen 声明照常放行。',
        codexImageGenerationBridgeEnabled: '启用 Hosted 桥接',
        codexImageGenerationBridgeEnabledDesc: '仅为非 Responses Lite 请求注入 hosted image_generation 工具；客户端显式携带的图片工具仍会放行。',
        codexImageGenerationBridgeDisabled: '不注入 Hosted 工具',
        codexImageGenerationBridgeDisabledDesc: '不注入 hosted 工具；客户端显式携带的 hosted 工具和本地 image_gen 声明仍会放行。',
        codexImageGenerationBridgeBadgeInherit: '渠道策略',
        codexImageGenerationBridgeBadgeEnabled: 'Hosted 桥接已开启',
        codexImageGenerationBridgeBadgeDisabled: '不注入 Hosted 工具',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          ...
          minTokens: '基础签到所需当日 Token 用量',
          minTokensHint: '用户当日 Token 用量（输入+输出+缓存合计）需达到该值才能领取基础签到；未达标显示"本日不够活跃"。0 = 不设门槛。按 Asia/Shanghai 自然日清零。',
          save: '保存签到设置',
          saved: '签到设置已保存',
          saveFailed: '保存签到设置失败'
        },
        affiliate: {
          title: '邀请积分',
          description: '老用户邀请新用户注册，新用户付款后老用户按比例获得积分。默认关闭。',
          enabled: '启用邀请积分',
          enabledHint: '关闭后用户菜单中的邀请页面入口隐藏、注册时忽略邀请码、新付款不再产生邀请积分。已有旧额度仍可转入余额。',
          rebateRate: '全局邀请积分比例',
          rebateRateHint: '付款后给邀请人的默认积分比例（0-100%，例如填写 10 表示 10%）。',
          freezeHours: '积分冻结期（小时）',
          freezeHoursDesc: '新产生的积分将在冻结期内无法使用。0 = 不冻结。',
          durationDays: '邀请有效期（天）',
      ...
      defaults: {
        ...
        affiliateRebateRate: '邀请积分比例',
        affiliateRebateRateHint: '付款后给邀请人的积分比例（0-100%，例如填写 10 表示 10%）',
      ...
      payment: {
        ...
        maxAmount: '最高金额',
        dailyLimit: '每日限额',
        balanceRechargeMultiplier: '充值到账倍率',
        ...
        subscriptionMaxValidityDays: '最长套餐有效期',
        subscriptionMinPlanRatio: '最小套餐订阅比例',
        subscriptionMaxPlanRatio: '最大套餐订阅比例',
        subscriptionPricingHint: '每日额度按 30 USD 一档；倍率在最低倍率生效额度前线性下降，之后保持最低倍率',
        ...
        refundFeeRateHint: '从实际原路退款金额中扣除的手续费百分比，0 表示不收取退款手续费',
        refundFeePreview: '预览：退款 100 元，用户到账 100 - {fee} 元',
        orderTimeout: '订单超时时间',
        ...
        field_adminPassword: 'BEpusdt 管理员密码',
        field_adminSecurePath: 'BEpusdt 安全入口路径',
        field_apiToken: 'BEpusdt API Token',
        field_rateMarkup: 'USDT 汇率调整',
        field_rateMarkupHint: '用于计算 USDT 应付金额的独立汇率调整，不影响支付宝/微信。',
        field_minUsdt: '最低支付 USDT',
        field_minUsdtHint: '低于此 USDT 数量的订单会被拒绝，默认 5。',
        field_networks: '允许的支付网络',
        field_networksHint: '逗号分隔，例如 usdt.trc20,usdt.polygon,usdt.solana。',
      ...
      upstreamBillingProbe: {
        title: '上游倍率自动探测',
        description: '定期从 OpenAI API Key 连接的上游 Sub2API 站点获取其声明的计费倍率。',
        enabled: '启用全局自动探测',
  ...
  userSubscriptions: {
    ...
    lifecycle: {
      renewTitle: '续费',
      changeTitle: '转套餐',
      renewHint: '续费当前订阅：每日额度不变，按整月延长服务天数（走支付，不扣余额）',
      changeHint: '新套餐将立即生效，旧套餐的剩余价值会抵扣差价。已使用的日、周、月额度会继续累计，并分别在下一个自然日、自然周、自然月自动重置。',
      noPlans: '暂无可选套餐',
      perDay: '/天',
      days: '天',
      dailyAmount: '每日额度',
      ...
      gatewayNote: '下一步会按所选支付方式折算为实付币种，支付成功后自动生效（不从余额扣）',
      goPay: '前往支付',
      errors: {
        NO_ACTIVE_SUBSCRIPTION: '没有生效中的订阅，无法续费/转套餐，请先购买',
        CHANGE_PLAN_DAILY_LIMIT: '今天已转过套餐（每自然日最多 1 次），请明天再试',
        CHANGE_PLAN_DOWNGRADE_NOT_ALLOWED: '新套餐价值低于当前卡剩余价值，不支持降档',
        CHANGE_PLAN_NO_PAYMENT_REQUIRED: '该变更无需补差价，请调整额度/时长',
        INVALID_SUBSCRIPTION_PARAMS: '每日额度或时长不在允许范围（时长须按整月）',
        INVALID_SUBSCRIPTION_INTENT: '请求类型无效',
  ...
  payment: {
    ...
    amountLabel: '充值金额',
    paymentAmount: '支付金额',
    paymentAmountWithCurrency: '支付金额（{currency}）',
    creditedBalance: '到账余额',
    creditedBalanceWithCurrency: '到账余额（{currency}）',
    quickAmounts: '快捷金额',
    quickAmountsWithCurrency: '快捷金额（{currency}）',
    customAmount: '自定义金额',
    customAmountWithCurrency: '自定义金额（{currency}）',
    subscriptionValueWithCurrency: '套餐价值（{currency}）',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
    cryptoNetwork: 'USDT 支付网络',
    cryptoNetworkHint: '请确认付款网络与钱包网络完全一致；不同网络的地址不能混用。',
    cryptoNetworks: {
      trc20: 'TRON（TRC20）',
      polygon: 'Polygon',
      solana: 'Solana',
    ...
    existingSubscriptionDesc: '当前账号已有生效套餐，不能再购买新套餐；请在我的订阅中续费或转套餐。',
    changeExistingPlan: '去转套餐',
    ...
    refundGatewayBase: '原路退款基数',
    refundFee: '退款手续费',
    refundUserReceives: '预计到账',
    subscriptionRefundNote: '订阅订单的实际申请金额由后端按剩余可退天数计算；退款手续费从实际原路退款金额中扣除。',
    balanceRefundNote: '余额订单按订单权益金额申请退款；退款手续费从实际原路退款金额中扣除。',
    ...
    planCard: {
      ...
      unlimited: '无限制',
      models: '模型',
      repurchaseTitle: '已有同分组的有效订阅。',
      repurchaseNotice: '购买将新增一张独立订阅卡（额度与现有订阅叠加），不会延长当前到期时间；扣费按激活先后依次进行。',
    ...
    admin: {
      ...
      subscriptionRefundClosesCard: '订阅退款会在网关退款成功后自动关闭关联的生效订阅；如果网关退款失败，订阅关闭会自动回滚。',
      refundSettlementTitle: '退款结算',
      refundCreditAmount: '回收权益金额',
      refundGatewayBase: '原路退款基数',
      refundFee: '退款手续费',
      refundUserReceives: '用户预计到账',
      refundFeeNote: '手续费按实际原路退款金额计算；提交时后端会按当前设置重新计算。',
