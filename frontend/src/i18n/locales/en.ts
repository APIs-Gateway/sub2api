export default {
  ...
  checkin: {
    ...
    todayTokens: 'Today tokens',
    tokensNeededHint: 'Use {amount} tokens today to unlock check-in',
    claimDaily: 'Check in',
    claimBonus: 'Claim bonus',
    claiming: 'Claiming…',
    doneToday: 'Done today',
    doneSubtitle: 'Already checked in today — comes back after the daily reset',
    notActiveButton: 'Not available today',
    notActiveEnough: "You're not active enough today, so check-in isn't available yet. Use the API actively, then check in.",
