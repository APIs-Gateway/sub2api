export default {
  ...
  userSubscriptions: {
    ...
    lifecycle: {
      ...
      gatewayNote: 'Renewal/change is completed via the payment gateway and takes effect after successful payment (not charged from balance).',
