export default {
  ...
  userSubscriptions: {
    ...
    lifecycle: {
      ...
      renewHint: 'Renew the same tier and extend service days (daily amount unchanged).',
      changeHint: 'Switch tier; the remaining value of the current card offsets the new plan, refunding or charging the difference.',
      noPlans: 'No plans available',
      perDay: '/day',
      days: 'days',
      confirm: 'Confirm',
      changeDiffNote: 'The exact charge/refund of the difference is settled upon confirmation.',
