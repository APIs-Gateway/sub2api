export default {
  ...
  nav: {
    ...
    affiliateManagement: 'Invites & Points',
    affiliateCashback: 'Invite Management',
    affiliateInviteRecords: 'Invite Records',
    affiliateRebateRecords: 'Invite Points Records',
    affiliateTransferRecords: 'Transfer Records',
    points: 'Invites & Points',
    pointsManagement: 'Points',
    pointsConfig: 'Points Config',
    pointsWithdrawals: 'Withdrawal Review',
  ...
  legacyInvite: {
    ...
    successTitle: 'Here is your invite code',
    successHint: 'This code can only be used once. Copy it before you head to the sign-up page.',
    alreadyClaimedHint: 'You claimed a code earlier — this is that same code.',
    ...
    disabledHint: 'Invite code claiming is currently closed.',
    errors: {
      ...
      generic: 'Could not claim the invite code, please try again later.',
  ...
  keys: {
    ...
    stablePriority: {
      ...
      description: 'When enabled, if all channels in your selected group become unavailable, requests automatically fall back across groups tier by tier to a more stable, higher-rate group; they switch back once the lower-rate group recovers.',
      billingWarning: 'Note: during fallback, usage is billed from your balance at the actually-serving higher-rate group’s rate, which may be higher than your original group.',
    },
  ...
  usage: {
    ...
    fiatTotalApprox: 'estimated at top-up rate',
    currencyFiat: '¥',
    currencyUsd: '$',
    ...
    upstreamModelMismatchHint: 'Upstream returned a different model than requested; the request was blocked (or observed)',
  ...
  availableChannels: {
    ...
    plansHint: 'A low price buys a large official-price quota; with a plan your effective price drops to a small fraction of official pricing.',
    goBuy: 'Buy',
  ...
  checkin: {
    ...
    activityNotMet: 'Activity threshold not met today',
    activityHint: 'Keep using the service, then check in later',
    claimDaily: 'Check in',
  ...
  points: {
    ...
    description: 'Earn points when your invitees pay. Redeem for balance, withdraw, or exchange for plans.',
    disabled: 'The points program is not available right now.',
    unit: 'pts',
    ...
    stats: {
      ...
      effectiveRate: 'Invite points rate',
      peg: 'Peg',
      firstPaymentRate: 'First payment {rate}',
      repeatPaymentRate: 'Later payments {rate}',
      pegValue: '1 pt = {value}',
    },
    invite: {
      code: 'Invite code',
      ...
      rewardTitle: 'Invite reward',
      rewardExample: 'If your invitee pays {amount}: about {firstPoints} pts on the first payment, then about {repeatPoints} pts per later payment.',
      rewardFormula: 'Each invited user’s first payment uses {firstRate}; later payments from that same user use {repeatRate}. 1 pt = {peg}.',
      rewardDisabled: 'The invite points rate is 0 right now, so invitee payments will not earn points.',
    },
    redeemBalance: {
      title: 'Redeem to balance',
      desc: 'Convert points to wallet balance using the fiat value and current recharge rate.',
      points: 'Points to redeem',
      estimate: 'You will get {amount} balance.',
      rateHint: '1 pt = {peg}; balance redemption uses 1 CNY = {rate} USD.',
      submit: 'Redeem',
      success: 'Redeemed to balance.',
    },
    withdraw: {
      title: 'Withdraw',
      desc: 'Submit a withdrawal request. Alipay pays in CNY; USDT is converted using the withdrawal rate and requires a network.',
      method: 'Payout method',
      alipay: 'Alipay',
      usdt: 'USDT',
      alipayAccount: 'Alipay account (phone / email)',
      alipayName: 'Alipay real name',
      usdtChain: 'USDT network',
      usdtChains: {
        trc20: 'TRC20',
        erc20: 'ERC20',
        bep20: 'BEP20',
    ...
    redeemPlan: {
      ...
      actionLabels: {
        purchase: 'Activation points price',
        renew: 'Renewal points price',
        change_plan: 'Change-plan diff points',
        downgrade: 'Cannot exchange to a lower tier',
      },
      submitLabels: {
        purchase: 'Exchange',
        renew: 'Renew',
        change_plan: 'Change plan',
        downgrade: 'Show reason',
      },
      quoteLoading: 'Calculating',
      quoteFailed: 'Failed to quote plan',
      downgradeBlocked: 'Your current plan has a higher daily amount. Choose same-tier renewal or a higher daily amount plan.',
      capSummary: 'Weekly / monthly cap',
      validity: '{n} days',
      submit: 'Exchange',
      success: 'Plan activated.',
      empty: 'No plans available for exchange.',
      confirm: 'Confirm {action} for {plan} and spend {points} points?',
    },
    ledger: {
    ...
    admin: {
      config: {
        ...
        enabled: 'Enable points program',
        earnSection: '1. Invite points',
        earnHint: 'Inviter points = invitee fiat amount paid x invite points rate / points-to-fiat ratio, rounded down. The invited user’s first fiat payment earns 2x points.',
        cashbackRate: 'Invite points rate (%)',
        cashbackRateHint: 'For example, 10 means points are calculated from 10% of the invitee paid amount.',
        freezeHours: 'Points freeze hours',
        freezeHoursHint: 'Frozen points become spendable after this period.',
        valueSection: '2. Point fiat value',
        peg: 'Fiat value of 1 point',
        pegHint: 'Enter the fiat value of 1 point. For example, 1 means 1 point = ¥1, and 0.01 means 100 points = ¥1. Balance redemption is then converted to USD balance using the balance recharge multiplier in payment settings; withdrawals and subscription deductions share this fiat value.',
        pegConfirmTitle: 'Confirm points-to-fiat ratio change',
        pegChangeConfirm: 'Change the points-to-fiat ratio from {from} to {to}? This re-prices all existing points and the change is audit-logged.',
        withdrawSection: '3. Points withdrawal',
        withdrawSectionHint: 'When enabled, users can request withdrawals using the points-to-fiat ratio.',
        withdrawMin: 'Minimum withdrawal points',
        withdrawFee: 'Withdrawal fee (%)',
        withdrawFeeHint: 'Net payout = points x points-to-fiat ratio x (1 - fee).',
        withdrawUSDCNYRate: 'USD/CNY daily rate',
        withdrawUSDCNYRateHint: 'Only for USDT withdrawals. The rate is snapshotted on each request.',
        redeemBalanceOn: '4. Allow points to balance',
        redeemBalanceHint: 'When enabled, points are converted by fiat value first, then to USD balance using the balance recharge multiplier in payment settings.',
        redeemPlanOn: '5. Allow full subscription deduction',
        redeemPlanHint: 'When enabled, points can fully deduct subscription purchases, renewals, and plan changes using the ratio above.',
        save: 'Save',
      ...
      withdrawals: {
        ...
        proof: 'Payout proof (optional)',
        approveConfirm: 'Mark this withdrawal as paid?',
        rejectConfirm: 'Reject and refund points to the user?',
        approved: 'Marked as paid.',
        rejected: 'Rejected and refunded.',
        empty: 'No withdrawals.',
        filterStatus: 'Status',
      },
      records: {
  ...
  admin: {
    ...
    channels: {
      ...
      display: {
        ...
        title: 'Pricing page display settings',
        intro: 'Choose which groups and models appear on the user "Pricing & Billing" page. Leave both empty to show everything.',
        modelsLabel: 'Models to show',
        searchModels: 'Search models...',
        clear: 'Clear',
        noModels: 'No matching models',
        emptyHint: 'Empty = show all models',
      ...
      form: {
        ...
        groupRateHint: 'The Nx badge is the group rate vs official pricing (user pays = unit price × rate)',
        wildcardHint: 'Wildcards supported, e.g. gpt-5* / claude-*; the more specific match wins',
        models: 'Models',
        ...
        codexImageGenerationBridge: 'Codex Hosted Image Bridge',
        codexImageGenerationBridgeHint: 'When enabled, OpenAI groups inject the hosted image_generation tool only for non-Responses Lite Codex /responses text requests. The bridge does not inject tools for Responses Lite; client-declared local image_gen handling follows client and account policy. Keep it off unless the routed accounts support image generation.',
    ...
    promptAudit: {
      title: 'Prompt Audit',
      description: 'Review redacted prompt audit events captured by the guard pipeline.',
      loadFailed: 'Failed to load prompt audit events',
      loadEventFailed: 'Failed to load prompt audit event',
      refresh: 'Refresh',
      filters: {
        decision: 'Decision',
        riskLevel: 'Risk level',
        keyword: 'Keyword',
        keywordPlaceholder: 'Search request ID, prompt hash, user, or API key',
      },
      decisions: {
        pass: 'Pass',
        flag: 'Flag',
      ...
      empty: 'No prompt audit events.',
      view: 'View',
      detail: {
        title: 'Prompt audit event #{id}',
        ...
        promptLengthChars: '{n} chars',
        messageCount: 'Message count',
        promptHash: 'Prompt hash',
        redactedPreview: 'Redacted preview',
        redactedPreviewHint: 'This preview is redacted at capture time. Full prompt text is never stored or shown here.',
        categories: 'Categories',
        matchedScanners: 'Matched scanners',
        scannerScores: 'Scanner scores',
        scannerEvidence: 'Scanner evidence',
        issues: 'Issue summaries',
        issuesEmpty: 'No issues recorded for this event.',
    ...
    channelMonitor: {
      ...
      advanced: {
        ...
        responseFormat: 'Response parsing',
        responseFormatJson: 'JSON (default)',
        responseFormatSse: 'SSE stream',
        responseFormatHintJson: 'Parse the upstream response as a single JSON document and extract text by field path (default).',
        responseFormatHintSse: 'Aggregate text from the upstream SSE event stream (same as "test account connection"). Use this when the upstream streams (stream:true) and JSON mode extracts empty text (replace-mode: upstream returned 2xx with empty text).',
    ...
    accounts: {
      ...
      openai: {
        ...
        codexImageGenerationBridge: 'Codex hosted image-generation bridge',
        codexImageGenerationBridgeDesc:
          'Controls the hosted image_generation bridge and client-declared image tools on Codex /responses text requests. Hosted injection applies only to non-Responses Lite requests; image-only model routing and standalone image-generation endpoints are unaffected.',
        codexImageGenerationBridgeInherit: 'Follow channel',
        codexImageGenerationBridgeInheritDesc: 'Do not write an account override; hosted injection for non-Responses Lite requests follows the channel or global policy, while client-declared hosted tools and local image_gen declarations pass through.',
        codexImageGenerationBridgeEnabled: 'Enable hosted bridge',
        codexImageGenerationBridgeEnabledDesc: 'Inject the hosted image_generation tool only for non-Responses Lite requests; client-declared image tools still pass through.',
        codexImageGenerationBridgeDisabled: 'No hosted injection',
        codexImageGenerationBridgeDisabledDesc: 'Do not inject the hosted tool; client-declared hosted tools and local image_gen declarations still pass through.',
        codexImageGenerationBridgeBadgeInherit: 'Channel policy',
        codexImageGenerationBridgeBadgeEnabled: 'Hosted bridge on',
        codexImageGenerationBridgeBadgeDisabled: 'No hosted injection',
    ...
    usage: {
      ...
      allUpstreamModelStates: 'All (model consistency)',
      upstreamModelMismatchOnly: 'Mismatch only',
      upstreamModelMatchOnly: 'Match only',
      ipAddress: 'IP',
    ...
    settings: {
      ...
      features: {
        ...
        checkin: {
          ...
          minTokens: 'Tokens required today for base check-in',
          minTokensHint: 'The user’s token usage today (input + output + cache) must reach this value to claim the base check-in; otherwise it shows “not active enough today”. 0 = no threshold. Resets per Asia/Shanghai calendar day.',
      ...
      registration: {
        ...
        gmailAliasFilterHint: 'Canonicalize Gmail aliases (dots and +suffix in the local part are ignored, and googlemail.com is treated as gmail.com) to the same address, blocking duplicate signups from one inbox. Applies to gmail.com and googlemail.com only',
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'Recharge Credit Multiplier',
        ...
        subscriptionMaxValidityDays: 'Maximum Plan Validity',
        subscriptionMinPlanRatio: 'Minimum Plan Subscription Ratio',
        subscriptionMaxPlanRatio: 'Maximum Plan Subscription Ratio',
        subscriptionPricingHint: 'Daily amount uses 30 USD steps; ratios decrease linearly until the minimum-ratio start amount and then remain at the minimum ratio',
        ...
        refundFeeRateHint: 'Deduct this percentage from the actual gateway refund amount; 0 means no refund fee',
        refundFeePreview: 'Preview: Refund 100, user receives 100 - {fee}',
        ...
        field_beBase: 'BEpusdt Internal URL',
        ...
        field_adminPassword: 'BEpusdt Admin Password',
        field_adminSecurePath: 'BEpusdt Secure Entry Path',
        field_apiToken: 'BEpusdt API Token',
        field_rateMarkup: 'USDT Rate Adjustment',
        field_rateMarkupHint: 'Independent adjustment used to calculate the USDT amount; it does not affect Alipay or WeChat Pay.',
        field_minUsdt: 'Minimum USDT Payment',
        field_minUsdtHint: 'Orders below this USDT amount are rejected; the default is 5.',
        field_networks: 'Allowed Payment Networks',
        field_networksHint: 'Comma-separated, for example usdt.trc20,usdt.polygon,usdt.solana.',
  ...
  userSubscriptions: {
    ...
    lifecycle: {
      ...
      renewHint: 'Renew the current subscription: daily amount unchanged, extend by whole months (paid via gateway, not from balance).',
      changeHint: 'Switch tier: pick a new daily amount and duration; the remaining value of the current card offsets it and you pay the difference (upgrade/even only, no downgrade).',
      noPlans: 'No plans available',
      perDay: '/day',
      days: 'days',
      dailyAmount: 'Daily amount',
      validity: 'Validity',
      dFixed: 'unchanged on renewal',
      price: 'Price',
      renewPrice: 'Renewal payment',
      renewValue: 'Renewal quota value',
      ...
      gatewayNote: 'The next step converts this value to the selected payment currency. It takes effect after successful payment (not charged from balance).',
      ...
      errors: {
        ...
        CHANGE_PLAN_DOWNGRADE_NOT_ALLOWED: 'The new plan is worth less than the current card\'s remaining value; downgrade is not supported.',
        CHANGE_PLAN_NO_PAYMENT_REQUIRED: 'This change requires no difference payment; adjust amount/duration.',
        INVALID_SUBSCRIPTION_PARAMS: 'Daily amount or duration is out of range (duration must be in whole months).',
        INVALID_SUBSCRIPTION_INTENT: 'Invalid request type.',
  ...
  payment: {
    ...
    creditedBalanceWithCurrency: 'Credited Balance ({currency})',
    quickAmounts: 'Quick Amounts',
    quickAmountsWithCurrency: 'Quick Amounts ({currency})',
    customAmount: 'Custom Amount',
    customAmountWithCurrency: 'Custom Amount ({currency})',
    subscriptionValueWithCurrency: 'Plan Value ({currency})',
    enterAmount: 'Enter amount',
    paymentMethod: 'Payment Method',
    cryptoNetwork: 'USDT Network',
    cryptoNetworkHint: 'Make sure the payment network exactly matches the wallet network; addresses from different networks cannot be mixed.',
    cryptoNetworks: {
      trc20: 'TRON (TRC20)',
      polygon: 'Polygon',
      solana: 'Solana',
    ...
    existingSubscriptionTitle: 'Active subscription already exists',
    existingSubscriptionDesc: 'This account already has an active subscription. You cannot buy a new one; renew or change the current plan from My Subscriptions.',
    changeExistingPlan: 'Change plan',
    ...
    rechargeMultiplier: 'Recharge rate: 1 {currency} = {usd} USD',
    rechargeRatePreview: 'Current rate: 1 {currency} = {usd} USD',
    refundReason: 'Refund Reason',
    refundReasonPlaceholder: 'Please describe your refund reason',
    refundGatewayBase: 'Gateway refund base',
    refundFee: 'Refund fee',
    refundUserReceives: 'Estimated received',
    subscriptionRefundNote: 'For subscription orders, the actual request amount is calculated by the backend from refundable remaining days. The refund fee is deducted from the actual gateway refund.',
    balanceRefundNote: 'For balance orders, the request amount is the order credit amount. The refund fee is deducted from the actual gateway refund.',
    ...
    errors: {
      ...
      INVALID_ORDER_TYPE: 'Only balance and subscription orders can request a refund.',
      ...
      REFUND_AMOUNT_LOCKED: 'A refund of this order was already submitted to the gateway; retries must use the same amount.',
      REFUND_FAILED: 'Refund failed.',
    },
    ...
    planCard: {
      ...
      unlimited: 'Unlimited',
      models: 'Models',
      repurchaseTitle: 'You already have an active subscription in this group.',
      repurchaseNotice: 'Purchasing adds a separate subscription card (quota stacks with your existing one) — it does not extend the current expiry; cards are consumed in activation order.',
    ...
    admin: {
      ...
      markRefundSucceeded: 'Mark refunded',
      ...
      subscriptionRefundClosesCard: 'Subscription refund will close the linked active subscription after the gateway refund succeeds. If the gateway refund fails, the subscription closure is rolled back.',
      refundSettlementTitle: 'Refund settlement',
      refundCreditAmount: 'Credit to claw back',
      refundGatewayBase: 'Gateway refund base',
      refundFee: 'Refund fee',
      refundUserReceives: 'User receives',
      refundFeeNote: 'Fee is calculated from the actual gateway refund amount. Backend recalculates it from current settings when you submit.',
