export default {
  ...
  points: {
    ...
    invite: {
      ...
      rewardFormula: 'First payment uses {firstRate}; later payments use {repeatRate}. 1 pt = {peg}.',
      rewardDisabled: 'The invite points rate is 0 right now, so invitee payments will not earn points.',
    },
    redeemBalance: {
      title: 'Redeem to balance',
      desc: 'Convert points to wallet balance at par.',
    ...
    admin: {
      config: {
        ...
        valueSection: '2. Points withdrawal / balance / subscription ratio',
        peg: 'Points-to-fiat ratio',
        pegHint: 'Enter the fiat value of 1 point. For example, 0.01 means 100 points = 1 fiat unit. Withdrawals, balance redemption, and subscription deductions share this ratio.',
        ...
        redeemBalanceHint: 'When enabled, points are converted to user balance using the ratio above.',
