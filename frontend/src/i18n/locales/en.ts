  ...
  points: {
    ...
    admin: {
      config: {
        ...
        enabledHint: 'Mutually exclusive with the legacy affiliate ($) rebate: turn off affiliate_enabled in system settings before enabling points, otherwise saving is rejected.',
        peg: 'Peg (balance units per point)',
        pegHint: 'e.g. 0.01 means 100 points = 1 balance unit. Treat as immutable once live.',
        pegChangeConfirm: 'Change the peg from {from} to {to}? This re-prices all existing points and the change is audit-logged.',
        cashbackRate: 'Reward rate (%)',
        ...
        redeemBalanceOn: 'Allow redeem to balance',
        redeemPlanOn: 'Allow exchange for plans',
        save: 'Save',
