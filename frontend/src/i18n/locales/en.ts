export default {
  ...
  points: {
    ...
    withdraw: {
      title: 'Withdraw',
      desc: 'Submit a withdrawal request. USDT payouts must include a network.',
  ...
  userSubscriptions: {
    ...
    lifecycle: {
      ...
      price: 'Price',
      renewPrice: 'Renewal price (plan value USD)',
      renewValue: 'Renewal plan value (USD)',
      changeDiff: 'Difference (plan value USD)',
      changeDiffValue: 'Difference value (USD)',
      newPlanPrice: 'New plan value',
      oldRemainingValue: 'Current card remaining value',
