export default {
  ...
  points: {
    ...
    stats: {
      ...
      effectiveRate: 'Your reward rate',
      peg: 'Peg',
      pegValue: '1 pt = {value}',
    },
    invite: {
    ...
    withdraw: {
      title: 'Withdraw',
      desc: 'Submit a withdrawal request. Payouts are reviewed and paid manually.',
    ...
    admin: {
      config: {
        ...
        earnSection: '1. Fiat top-up to points',
        earnHint: 'Inviter points = fiat amount paid x reward rate / points-to-fiat ratio, rounded down. The invited user’s first fiat payment earns 2x points.',
        cashbackRate: 'Fiat top-up reward rate (%)',
        cashbackRateHint: 'For example, 10 means points are calculated from 10% of the paid amount.',
