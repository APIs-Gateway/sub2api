  ...
  admin: {
    ...
    accounts: {
      ...
      columns: {
        ...
        notes: 'Notes',
        priority: 'Priority',
        billingRateMultiplier: 'User Rate',
        weight: 'Weight',
        status: 'Status',
        schedulable: 'Schedulable',
      ...
      billingRateMultiplier: 'User Rate Multiplier',
      billingRateMultiplierHint: 'Requests through this account are billed at this rate. 0 = free, default 1.0',
      expiresAt: 'Expires At',
