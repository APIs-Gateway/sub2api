...
import type { APIMode, Provider, MonitorStatus, ResponseFormat } from '@/api/admin/channelMonitor'
...
export const RESPONSE_FORMAT_JSON: ResponseFormat = 'json'
export const RESPONSE_FORMAT_SSE: ResponseFormat = 'sse'
