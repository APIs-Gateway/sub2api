...
export interface SystemSettings {
  ...
  session_binding_enabled: boolean; // Session IP/UA binding
  step_up_enabled: boolean; // Sensitive-operation step-up 2FA
  ...
  payment_subscription_max_plan_ratio: number;
