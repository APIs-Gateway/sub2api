      ...
      <div class="mb-8">
        <div class="relative inline-block">
          ...
          <div class="absolute inset-0 flex items-center justify-center">
            <div
              class="flex h-24 w-24 items-center justify-center rounded-2xl bg-gray-900 dark:bg-gray-100 dark:text-gray-900"
            >
              <svg
                class="h-12 w-12 text-white dark:text-gray-900"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="1.5"
