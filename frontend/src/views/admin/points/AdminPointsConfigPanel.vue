<template>
  <div class="space-y-6">
    ...
    <div v-else-if="settings" class="card p-6 max-w-4xl">
      ...
      <div class="mt-6">
        <button type="button" class="btn btn-primary" :disabled="saving" @click="save">{{ t('points.admin.config.save') }}</button>
      </div>
    </div>
    ...
    >
      ...
      <template #footer>
        <button type="button" class="btn btn-secondary" :disabled="saving" @click="cancelPegChange">{{ t('common.cancel') }}</button>
        <button type="button" class="btn btn-danger" :disabled="saving" @click="confirmPegChange">{{ t('common.confirm') }}</button>
      </template>
    </BaseDialog>
  </div>
</template>
