        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          <div class="card p-5">
            <div class="mb-3 flex items-start justify-between">
              ...
              <Icon name="server" size="sm" class="text-gray-300 dark:text-dark-600" :stroke-width="1.5" />
            </div>
            <p class="text-2xl font-semibold tabular-nums text-gray-900 dark:text-white">
          ...
          <div class="card p-5">
            <div class="mb-3 flex items-start justify-between">
              ...
              <Icon name="userPlus" size="sm" class="text-gray-300 dark:text-dark-600" :stroke-width="1.5" />
            </div>
            <p class="text-2xl font-semibold tabular-nums text-gray-900 dark:text-white">
