    ...
    <div class="mx-auto max-w-2xl space-y-6">
      ...
      <div class="card overflow-hidden">
        <div class="bg-gray-900 px-6 py-8 text-center dark:bg-dark-800">
          <div
            class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10"
          >
            <Icon name="creditCard" size="xl" class="text-white" />
          </div>
          <p class="text-sm font-medium text-gray-400">{{ t('redeem.currentBalance') }}</p>
          <p class="mt-2 text-4xl font-semibold tabular-nums text-white">
