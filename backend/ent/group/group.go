...
const (
	...
	// FieldStablePriorityFallbackGroupID holds the string denoting the stable_priority_fallback_group_id field in the database.
	FieldStablePriorityFallbackGroupID = "stable_priority_fallback_group_id"
...
var Columns = []string{
	...
	FieldStablePriorityFallbackGroupID,
	FieldModelRouting,
...
// ByStablePriorityFallbackGroupID orders the results by the stable_priority_fallback_group_id field.
func ByStablePriorityFallbackGroupID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldStablePriorityFallbackGroupID, opts...).ToFunc()
}
