...
func (*SubscriptionPlan) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case subscriptionplan.FieldDailyAmountUsd, subscriptionplan.FieldPrice, subscriptionplan.FieldOriginalPrice:
		...
		case subscriptionplan.FieldPlatform, subscriptionplan.FieldName, subscriptionplan.FieldDescription, subscriptionplan.FieldCurrency, subscriptionplan.FieldValidityUnit, subscriptionplan.FieldFeatures, subscriptionplan.FieldProductName:
