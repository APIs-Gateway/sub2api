...
// SubscriptionOverdraftGuard applies equality check predicate on the "subscription_overdraft_guard" field. It's identical to SubscriptionOverdraftGuardEQ.
func SubscriptionOverdraftGuard(v bool) predicate.User {
...
// SubscriptionOverdraftGuardEQ applies the EQ predicate on the "subscription_overdraft_guard" field.
func SubscriptionOverdraftGuardEQ(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldSubscriptionOverdraftGuard, v))
}
