...
func (_c *APIKeyCreate) SetStablePriorityEnabled(v bool) *APIKeyCreate {
...
func (_c *APIKeyCreate) SetNillableStablePriorityEnabled(v *bool) *APIKeyCreate {
	if v != nil {
...
func (_c *APIKeyCreate) defaults() error {
	...
	if _, ok := _c.mutation.StablePriorityEnabled(); !ok {
		v := apikey.DefaultStablePriorityEnabled
		_c.mutation.SetStablePriorityEnabled(v)
	}
	return nil
}
...
func (_c *APIKeyCreate) check() error {
	...
	if _, ok := _c.mutation.StablePriorityEnabled(); !ok {
		return &ValidationError{Name: "stable_priority_enabled", err: errors.New(`ent: missing required field "APIKey.stable_priority_enabled"`)}
	}
...
// SetStablePriorityEnabled sets the "stable_priority_enabled" field.
func (u *APIKeyUpsert) SetStablePriorityEnabled(v bool) *APIKeyUpsert {
	u.Set(apikey.FieldStablePriorityEnabled, v)
	return u
}

// UpdateStablePriorityEnabled sets the "stable_priority_enabled" field to the value that was provided on create.
func (u *APIKeyUpsert) UpdateStablePriorityEnabled() *APIKeyUpsert {
	u.SetExcluded(apikey.FieldStablePriorityEnabled)
	return u
}
...
// SetStablePriorityEnabled sets the "stable_priority_enabled" field.
func (u *APIKeyUpsertOne) SetStablePriorityEnabled(v bool) *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
...
// UpdateStablePriorityEnabled sets the "stable_priority_enabled" field to the value that was provided on create.
func (u *APIKeyUpsertOne) UpdateStablePriorityEnabled() *APIKeyUpsertOne {
	return u.Update(func(s *APIKeyUpsert) {
...
// SetStablePriorityEnabled sets the "stable_priority_enabled" field.
func (u *APIKeyUpsertBulk) SetStablePriorityEnabled(v bool) *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.SetStablePriorityEnabled(v)
	})
}
...
// UpdateStablePriorityEnabled sets the "stable_priority_enabled" field to the value that was provided on create.
func (u *APIKeyUpsertBulk) UpdateStablePriorityEnabled() *APIKeyUpsertBulk {
	return u.Update(func(s *APIKeyUpsert) {
		s.UpdateStablePriorityEnabled()
	})
}
