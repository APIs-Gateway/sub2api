...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	subscriptionService := service.NewSubscriptionService(groupRepository, userSubscriptionRepository, userRepository, billingCacheService, apiKeyAuthCacheInvalidator, client, configConfig)
