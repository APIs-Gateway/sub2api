...
func RegisterGatewayRoutes(
	...
	unsupportedMedia := func(c *gin.Context, message string) {
	...
	imagesHandler := func(c *gin.Context) {
		...
		default:
			unsupportedMedia(c, "Images API is not supported for this platform")
		}
	}
	videoGenerationHandler := func(c *gin.Context) {
		...
		unsupportedMedia(c, "Videos API is not supported for this platform")
	}
	...
	videoStatusHandler := func(c *gin.Context) {
		// Status requests do not carry a model. Composite groups therefore need
		// to use the Grok handler and let account scheduling enforce capacity.
	...
	videoContentHandler := func(c *gin.Context) {
		// Content requests inherit the same composite target routing as status.
		if getGroupPlatform(c) == service.PlatformGrok || getGroupPlatform(c) == service.PlatformComposite {
	...
	r.GET("/backend-api/wham/usage", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), h.Gateway.WhamUsage)
	r.GET("/backend-api/codex/wham/usage", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), h.Gateway.WhamUsage)
