...
type GatewayConfig struct {
	...
	// OpenAIProxyStreamCircuit temporarily quarantines proxies after repeated
	// post-output stream disconnects.
...
func setDefaults() {
	...
	viper.SetDefault("gateway.grok_response_header_timeout", 600)
