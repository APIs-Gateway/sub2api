...
func TestAuthCacheInvalidationMigrationDialectHelpers(t *testing.T) {
	...
	require.True(t, migrationAppliesToDatabase("185_group_auth_cache_image_generation.sql", migrationDatabasePostgres))
	require.False(t, migrationAppliesToDatabase("185_group_auth_cache_image_generation.sql", migrationDatabaseMySQL))
	require.False(t, migrationAppliesToDatabase("185_group_auth_cache_image_generation.sql", migrationDatabaseSQLite))
	require.True(t, migrationAppliesToDatabase("185_group_auth_cache_image_generation_mysql.sql", migrationDatabaseMySQL))
	require.False(t, migrationAppliesToDatabase("185_group_auth_cache_image_generation_mysql.sql", migrationDatabaseSQLite))
	require.True(t, migrationAppliesToDatabase("185_group_auth_cache_image_generation_sqlite.sql", migrationDatabaseSQLite))
