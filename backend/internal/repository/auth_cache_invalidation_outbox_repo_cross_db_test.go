...
func TestAuthCacheInvalidationMigrationDialectHelpers(t *testing.T) {
	...
	require.True(t, migrationAppliesToDatabase(latestAPIKeyIPIndexMigration, migrationDatabasePostgres))
	require.False(t, migrationAppliesToDatabase(latestAPIKeyIPIndexMigration, migrationDatabaseMySQL))
	require.False(t, migrationAppliesToDatabase(latestAPIKeyIPIndexMigration, migrationDatabaseSQLite))
