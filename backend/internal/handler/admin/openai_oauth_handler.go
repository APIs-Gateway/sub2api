...
type OpenAIOAuthHandler struct {
	...
	validateCodexPAT   func(context.Context, string, string) (*service.OpenAITokenInfo, error)
}
...
func NewOpenAIOAuthHandler(
	...
	return &OpenAIOAuthHandler{
		...
		validateCodexPAT:   openaiOAuthService.ValidateCodexPersonalAccessToken,
	}
}
...
func (h *OpenAIOAuthHandler) CreateAccountFromCodexPAT(c *gin.Context) {
	...
	tokenInfo, err := h.validateCodexPAT(c.Request.Context(), req.AccessToken, proxyURL)
	if err != nil {
		response.ErrorFrom(c, err)
		return
	}
