...
func TestParseGatewayRequest_AnthropicNormalizesClaudeCodeLongContextModel(t *testing.T) {
	tests := []struct {
		name  string
		model string
		want  string
...
func TestParseGatewayRequest_NonAnthropicPreservesClaudeCodeLongContextModel(t *testing.T) {
