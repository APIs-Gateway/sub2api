...
// TestForwardAsAnthropic_GPT6AstraPromptCacheIdentityStableAcrossAppendedTurns
// 验证 /v1/messages 路径下 gpt-6-astra（含裸别名 gpt-6）在多轮对话追加消息时
// 保持稳定的 prompt_cache_key/session_id，覆盖 shouldAutoInjectPromptCacheKeyForCompat
// 新增的 Astra 分支（pr-6620 的核心修复点）。
