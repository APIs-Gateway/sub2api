...
func TestIsAnthropicFableModel(t *testing.T) {
	...
	require.True(t, isAnthropicFableModel("Claude-Fable-5"))
	require.True(t, isAnthropicFableModel("claude-fable-5-20260601"))
	require.False(t, isAnthropicFableModel("claude-sonnet-4-6"))
	require.False(t, isAnthropicFableModel("claude-fable-5-preview"))
	require.False(t, isAnthropicFableModel("not-claude-fable-5"))
	require.False(t, isAnthropicFableModel("claude-fable-5[10m]"))
