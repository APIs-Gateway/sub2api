...
func TestAdminService_CreateGroup_PreservesMessagesDispatchFieldsForGrokPlatform(t *testing.T) {
	repo := &groupRepoStubForAdmin{}
	svc := &adminServiceImpl{groupRepo: repo}
	...
	require.Equal(t, "grok-4.3", repo.created.MessagesDispatchModelConfig.SonnetMappedModel)
}
...
func TestAdminService_CreateGroup_InvalidRequestFallbackAllowsSubscriptionType(t *testing.T) {
	fallbackID := int64(10)
	repo := &groupRepoStubForInvalidRequestFallback{
		groups: map[int64]*Group{
			fallbackID: {ID: fallbackID, Platform: PlatformAnthropic, SubscriptionType: SubscriptionTypeStandard},
...
func TestAdminService_UpdateGroup_InvalidRequestFallbackAllowsSubscriptionType(t *testing.T) {
	fallbackID := int64(10)
	existing := &Group{
		ID:                              1,
		Name:                            "g1",
...
func TestAdminService_UpdateGroup_InvalidRequestFallbackAllowsSubscriptionFallbackGroup(t *testing.T) {
	fallbackID := int64(10)
	existing := &Group{
		ID:               1,
		Name:             "g1",
