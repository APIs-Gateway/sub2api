...
const (
	AdminComplianceVersion        = "v2026.09.22"
	...
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意本服务部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to this service's Deployment and Operation Compliance Commitment"
