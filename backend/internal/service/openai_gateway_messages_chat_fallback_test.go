...
func TestForwardAsAnthropic_ForceChatCompletionsPreservesMappedGPT56MaxEffort(t *testing.T) {
	body := []byte(`{"model":"sol","max_tokens":32,"messages":[{"role":"user","content":"hello"}],"reasoning_effort":"max","stream":false}`)
