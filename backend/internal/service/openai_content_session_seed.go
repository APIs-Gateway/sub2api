...
// seed only when it contains a meaningful user/input anchor.
...
// of an OpenAI-format request. User and assistant content are excluded so
// independent prompts with the same system/tool prefix share one cache route.
