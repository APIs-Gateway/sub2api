...
func TestBuildUpstreamModelsRequestSupportsGrokOAuth(t *testing.T) {
	...
	svc := &AccountTestService{
		...
		grokTokenProvider: NewGrokTokenProvider(nil, nil, nil),
	}
...
func TestBuildUpstreamModelsRequestGrokOAuthAppliesCustomBaseURL(t *testing.T) {
	t.Parallel()
	...
	account := grokOAuthModelSyncTestAccount("https://relay.example/v1")
