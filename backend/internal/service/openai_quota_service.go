...
func (s *OpenAIQuotaService) QueryUsage(ctx context.Context, accountID int64) (*OpenAIQuotaUsage, error) {
	...
	details := s.queryResetCreditDetailsForAccount(callCtx, client, accessToken, chatGPTAccountID, fedRAMP, accountID)
...
func (s *OpenAIQuotaService) queryResetCreditDetails(ctx context.Context, client *req.Client, accessToken, chatGPTAccountID string, fedRAMP bool, accountID int64) *openAIRateLimitResetCreditDetails {
	return s.queryResetCreditDetailsForAccount(ctx, client, accessToken, chatGPTAccountID, fedRAMP, accountID)
}

func (s *OpenAIQuotaService) queryResetCreditDetailsForAccount(ctx context.Context, client *req.Client, accessToken, chatGPTAccountID string, fedRAMP bool, accountID int64) *openAIRateLimitResetCreditDetails {
