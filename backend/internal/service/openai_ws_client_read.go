...
// readOpenAIWSClientMessageWithTimeoutStart starts the timeout immediately by
// default, or after timeoutStart when timeoutActive reports that the reader is
