...
// toolAnthropicSSEStream mirrors upstream's helper from
// openai_gateway_anthropic_native_pump_test.go (not present in this fork):
// tool_use starts with the {} input placeholder and streams the real input via
// input_json_delta.
