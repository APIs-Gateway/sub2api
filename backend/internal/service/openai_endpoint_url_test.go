...
func TestBuildOpenAIEndpointURLPreservesURLComponents(t *testing.T) {
	tests := []struct {
		...
		{name: "percent-encoded path segment is preserved", base: "https://upstream.example/v1", endpoint: "/v1/images/generations/task%20id%2Fwith%20slash", want: "https://upstream.example/v1/images/generations/task%20id%2Fwith%20slash"},
	}
