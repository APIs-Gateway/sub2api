...
func (s *OpenAIGatewayService) handleOpenAIImagesOAuthResponseError(
	...
	return &UpstreamFailoverError{
		...
		RetryableOnSameAccount: openAIRetryableOnSameAccount(upstreamErr.StatusCode, upstreamErr.clientMessage(), responseBody, account.IsPoolMode() && account.IsPoolModeRetryableStatus(upstreamErr.StatusCode)),
	}
}
