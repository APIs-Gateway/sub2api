...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeCrypto:    {"adminpassword": {}, "adminsecurepath": {}, "apitoken": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeCrypto:    {"adminpassword": {}, "adminsecurepath": {}, "apitoken": {}, "bebase": {}, "publicbase": {}, "behost": {}, "ratemarkup": {}, "minusdt": {}, "timeoutsec": {}, "networks": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypeCrypto: true,
}
...
// easyPayCustomMethodTypeConflictsWithBuiltin rejects custom method codes that
// GetBasePaymentType (backend/internal/payment/types.go) would prefix-collapse
// into an existing built-in payment type (alipay/wxpay/crypto), which would
// otherwise silently merge the custom EasyPay method's limits, visibility, and
// icon into an unrelated provider's.
